...
class SwiftonizeDev < Formula
  ...
  def install
    ...
    if self.plat == :x86_64
      then
        bin.install ".build/x86_64-apple-macosx/release/SwiftonizeExecutable" => "swiftonize-dev"
      else
        bin.install ".build/arm64-apple-macosx/release/SwiftonizeExecutable" => "swiftonize-dev"
    end
